...
""".mp MetaPost / MetaUML
	autocmd FileType mp inoremap ,s input metauml;<Enter>beginfig();<Enter><Tab><++><Enter>endfig;<Enter>end<Esc>3kf)i
	...
	""" Links
 	autocmd FileType mp inoremap ,L clink()(<++>);<Enter><<Tab><++><Esc>kf)i
	autocmd FileType mp inoremap ,las clink(association)();<Enter><Tab><++><Esc>kf)f)i
	autocmd FileType mp inoremap ,lin clink(inheritance)();<Enter><Tab><++><Esc>kf)f)i
	autocmd FileType mp inoremap ,lre clink(realization)();<Enter><Tab><++><Esc>kf)f)i
	autocmd FileType mp inoremap ,lagg clink(aggregation)();<Enter><Tab><++><Esc>kf)f)i
